  ...
  return (
    <div className="w-full max-w-6xl grid grid-cols-12 gap-6">
      ...
      <main className="col-span-12 md:col-span-9">
        ...
        {tab === TABS.ACTIVITY && (
          <ActivityTab userId={myUserId} userNickname={userNickname}/>
        )}
...
const ActivityTab = ({ userId, userNickname }) => {
  const boardMyListLink = `/board/list?type=w&keyword=${encodeURIComponent(userNickname || "")}`;
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="판매 중">
        <div className="flex gap-2 mb-3">
          ...
          <Link className="px-3 py-2 rounded bg-blue-600 text-white" to="/product/register">상품 등록</Link>
        </div>
