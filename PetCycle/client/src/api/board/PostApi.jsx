...
export const getFile = (fileName) => {
  // axios 요청 x 이미지 태그의 src 속성에 사용될 URL 반환 용도
  return `${host}/files/view/${fileName}`;
};

// 게시글 목록 조회(jwt 필요x)
export const getPostList = async (pageParam) => {
  // ✨ pageParam에서 type과 keyword도 구조 분해 할당 ✨
...
// 게시글 수정 (JWT 필요) - FormData를 사용하여 파일 업로드/교체/유지 처리
