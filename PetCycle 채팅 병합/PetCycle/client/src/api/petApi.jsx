...
// ----- 서버 베이스: 로컬 기본은 http://localhost:8080 -----
export const API_SERVER_HOST = (import.meta.env.VITE_API_SERVER || "http://localhost:8080").replace(/\/+$/, "");
...
export async function registerPet(form = {}) {
  ...
  if (form.petTypeId != null && form.petTypeId !== "") fd.append("petTypeId", form.petTypeId);
