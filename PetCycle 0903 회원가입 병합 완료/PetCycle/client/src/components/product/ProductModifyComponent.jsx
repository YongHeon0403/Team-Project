...
export default function ProductModifyComponent(props) {
  ...
  const [tagInput, setTagInput] = useState(""); // ✅ (1)과 함께 추가된 상태
    ...
    (async () => {
      ...
      try {
        ...
        setForm({
          ...
          addr: d.addr ?? "",
          tagNames: Array.isArray(d.tags) ? d.tags : [], // ✅ (2) 완료
        });
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div>
            <label className="block mb-1 font-medium">
              태그{" "}
              <span className="text-xs text-gray-500">(최대 {MAX_TAGS})</span>
            </label>
